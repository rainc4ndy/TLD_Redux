...
const SCRIPT_COMMAND attack_using_weapon_actor = { 0x0634, "iiiii" };

const SCRIPT_COMMAND clear_actor_task = { 0x0687, "i" };

const SCRIPT_COMMAND create_corona_with_radius = { 0x024F, "fdddddfff" };

const SCRIPT_COMMAND car_x_angle = { 0x077D, "d" };
const SCRIPT_COMMAND car_y_angle = { 0x06BE, "d" };
const SCRIPT_COMMAND set_car_rotation_velocity_XYZ_through_center_of_body = { 0x07DA, "dfff" };