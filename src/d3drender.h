...
public:
	...
	void D3DLine(int x, int y, int x2, int y2, D3DCOLOR color, float thickness);

	void D3DCircle(int centerX, int centerY, float radius, D3DCOLOR color, int numSegments);
